...
from algorithm.models import User, Category, Algorithm, UrlAlgorithm, UrlTaskAlgorithm, TaskAlgorithm, ImageAlgorithm, Comment
...
class CategoryAlgorithmSerializer(ModelSerializer):
    ...
    class Meta:
        model = Category
        fields = ('id', 'is_published', 'created_at', 'title', 'slug', 'algorithms')
...
class FullCategoryAlgorithmSerializer(ModelSerializer):
    ...
    class Meta:
        model = Category
        fields = ('id', 'is_published', 'created_at', 'title', 'description', 'slug', 'algorithms')
...
class UrlToTheoryAlgorithmSerializer(ModelSerializer):
    ...
    class Meta:
        model = UrlAlgorithm
        fields = ('id', 'is_published', 'created_at', 'algorithm', 'title', 'url')
...
class ImageToAlgorithmSerializer(ModelSerializer):
    algorithm = SerializerMethodField()
    class Meta:
        model = ImageAlgorithm
        fields = ('id', 'is_published', 'created_at', 'algorithm', 'image', 'caption', 'alt')
    def get_algorithm(self, obj):
        return obj.algorithm.slug
...
class AlgorithmSerializer(ModelSerializer):
    ...
    class Meta:
        model = Algorithm
        fields = ('id', 'is_published', 'created_at', 'category', 'title', 'slug',)
...
class FullAlgorithmSerializer(ModelSerializer):
    category = SerializerMethodField()
    url_to_theory_algorithm = UrlToTheoryAlgorithmSerializer(many=True, required=False)
    url_to_online_tasks = UrlToOnlineTaskAlgorithmSerializer(many=True, required=False)
    ...
    class Meta:
        ...
        fields = ('id', 'is_published', 'created_at', 'category', 'title',
                  ...
                  'url_to_online_tasks', 'url_to_theory_algorithm', 'task_to_algorithm',
                  'photo_algorithm', 'comments')
...
class CategoryDataStructureSerializer(ModelSerializer):
    data_structures = DataStructureToCategorySertializer(many=True, required=False)
    class Meta:
        model = structure_models.CategoryDateStructure
        fields = ('id', 'is_published', 'created_at', 'title', 'slug', 'data_structures')
...
class FullCategoryDataStructureSerializer(ModelSerializer):
    ...
    class Meta:
        model = structure_models.CategoryDateStructure
        fields = ('id', 'is_published', 'created_at', 'title', 'description', 'slug', 'data_structures')
...
class UrlToTheoryDataStructureSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'is_published', 'created_at', 'data_structure', 'title', 'url')
...
class ImageToDataStructureSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'is_published', 'created_at', 'data_structure', 'image', 'caption', 'alt')
    def get_algorithm(self, obj):
        return obj.data_structure.slug
...
class CommentToDataStructureSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'author','data_structure', 'text', 'created_at')
    def get_algorithm(self, obj):
        return obj.data_structure.slug
    def get_author(self, obj):
        return obj.author.username
...
class FullDataStructureSerializer(ModelSerializer):
    category = SerializerMethodField()
    url_to_theory_data_structure = UrlToTheoryDataStructureSerializer(many=True, required=False)
    task_to_data_structure = TaskToDataStructureSerializer(many=True, required=False)
    photo_data_structure = ImageToDataStructureSerializer(many=True, required=False)
